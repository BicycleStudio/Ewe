...
Logger::Logger(std::string className, LoggerConfig config) : _className(className) {
...
bool Logger::_accept(LOG_LEVEL lvl) {
...
void Logger::print(std::string& message, LOG_LEVEL lvl, std::string& lvl_s, std::ostream& stream) {
